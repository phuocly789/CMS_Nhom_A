...
if (! function_exists('jobscout_header')) :
        ...
        ?>
            <header id="masthead" class="site-header header-one" itemscope itemtype="https://schema.org/WPHeader">
                <div class="header-main">
                    <div class="" style="margin: 0 auto; display: flex; justify-content: space-between; align-items: center; padding: 10px 40px;">
                        <?php
    ...
    <footer id="colophon" class="site-footer" itemscope itemtype="https://schema.org/WPFooter">
        ...
        <section class="newsletter" style="background-color: orange; color: white; text-align: center;">
        ...
        <!-- Footer Links -->
        <section class="footer-links" style="text-align: center; padding: 20px 0;">
            <h3 style="font-size: 20px;"><?php jobscout_site_branding(false); ?></h3>
